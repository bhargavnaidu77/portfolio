    ...
    >
      <div className="grid grid-cols-12 gap-y-12 md:gap-x-8">
        ...
        <div className="col-span-12 md:col-span-10">
          ...
          {/* Stats strip */}
          <Reveal delay={0.3}>
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 border-t border-rule/70">
              {[
                ...
                <div
                  key={i}
                  className="border-b border-rule/70 md:border-b-0 md:border-r last:border-r-0 border-rule/70 py-7 pr-6 last:pr-0"
                >
